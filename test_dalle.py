...
from ai_image_gen_mcp.models.dalle import DALLEModel
...
async def test_dalle():
    ...
    # Create model
    model = DALLEModel(api_key=config.openai_api_key, model="dall-e-3")
    print("✓ DALL-E 3 model initialized")
    ...
    prompt = "A serene mountain landscape at sunset with purple and orange sky"
    ...
    try:
        ...
        if image_data_list:
            ...
            # Save to storage
            filename = "test_dalle_landscape.png"
            metadata = {
                "prompt": prompt,
                "model": "dall-e-3",
                "size": "1792x1024",
